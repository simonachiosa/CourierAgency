...
#clienti th {
 ...
 <h1><center><i>Selectati tabela de lucru</i></center></h1>
...
<input type="text" id="myInput2" onkeyup="myFunction2()" placeholder="Cauta adresa plecare" title="Type in a name">
...
<b>Data plasare:</b>
<input type="date" name="data_plasare" value=""  size="20" required /><br><br>
<b>Adresa plecare:</b>
<input type="text" name="adresa_plecare" value=""  size="20" required /><br><br>
<b>Adresa destinatie:</b>
<input type="text" name="adresa_destinatie" value=""  size="20" required /><br><br>
<b>Cod Hub:</b>
