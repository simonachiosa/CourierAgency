...
$query4 = mysqli_query($con, "select * from `clienti`
inner join `factura` using(`cod_clienti`)
inner join `colet` using(`cod_colet`)
inner join `comenzi` using(`cod_comanda`)
where `cod_clienti`  = '".$_GET['invoiceID']."'");
